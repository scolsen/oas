...
(s/def ::parameter (s/keys :req-un [::name ::in]
                           :opt-un [::description ::required ::deprecated ::allowEmptyValue ::style ::explode ::allowReserved ::schema ::example ::examples ::content]))
...
(s/def ::encoding (s/keys :req-un []
                          :opt-un [::contentType ::headers ::style ::explode ::allowReserved]))
...
(s/def ::link (s/keys :req-un []
                      :opt-un [::operationRef ::operationId ::parameters ::requestBody ::description ::server]))
